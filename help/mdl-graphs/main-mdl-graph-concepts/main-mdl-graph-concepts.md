...
![MDL graph's root node](main-mdl-graph-concepts.resources/main-mdl-graph-concepts-02.png "MDL graph's root node")
...
![MDL node connector types](main-mdl-graph-concepts.resources/main-mdl-graph-concepts-03.png "MDL node connector types"){width="512px"}
...
![Filtered node creation](main-mdl-graph-concepts.resources/main-mdl-graph-concepts-04.gif "Filtered node creation")
...
![Exposed graph inputs](main-mdl-graph-concepts.resources/main-mdl-graph-concepts-05.png "Exposed graph inputs")
