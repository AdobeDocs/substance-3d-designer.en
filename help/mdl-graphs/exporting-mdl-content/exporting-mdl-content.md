...
This page describes the export processes related to [MDL graphs](../../help/mdl-graphs/mdl-graphs.md) and materials in Substance 3D Designer.
...
The exported module will contain the definitions of *all* the MDL materials defined by an [MDL graph](../../help/mdl-graphs/mdl-graphs.md) in the package.
...
* The [3D View](../../help/interface/3d-view/3d-view.md) panel, using the <b>Materials &gt; my\_material &gt; Export preset...</b> menu option
...
>[!WARNING]
>
> While exporting an MDL module from the [Explorer](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) panel results in an MDL module holding *all* MDL materials defined by an MDL graph in the package, exporting an MDL preset from the [3D View](../../help/interface/3d-view/3d-view.md) results in an MDL module holding *only* the definition of the MDL materials applied to the *selected material* in the menu – `my_material` in this example.
...
The exported module archive will contain MDL module holding the definitions of *all* the MDL materials defined by an [MDL graph](../../help/mdl-graphs/mdl-graphs.md) in the package. If a [Substance graph](../../help/compositing-graphs/substance-compositing-graphs.md) is [instanced into an MDL graph](../../help/mdl-graphs/compositing-graphs-and/substance-compositing-graphs-and-mdl-materials.md) and connected to a stream going to the [Root](../../help/mdl-graphs/main-mdl-graph-concepts/main-mdl-graph-concepts.md) node, the textures it outputs are *saved into the archive*.
