...
![Exposed state of node inputs](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-01.png "Exposed state of node inputs")
...
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-02.png) Copy value to a new node and link it to this parameter**: creates an *input connector* for this property and connects it to a *new node* which outputs the current value of this property
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-03.png) Create an input pin for this parameter**: creates an *input connector* for this property
* **![](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-04.png) Reset this parameter to its default value**: when no value is connected to this property’s input connector, resets its value to its default
...
![Exposed node parameters](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-06.png "Exposed node parameters")
...
![&quot;Expose&quot; option in a node's contextual menu](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-07.png "&quot;Expose&quot; option in a node's contextual menu")
...
![Exposing nodes into graph inputs](exposing-parameters-in-mdl-graphs.resources/exposing-parameters-in-mdl-graphs-08.gif "Exposing nodes into graph inputs")
