...
![redesigner new graph window](version-15-1.resources/version-15-1-02.png){zoomable="yes"}
...
![New graph creation window for samples](version-15-1.resources/version-15-1-03.png){zoomable="yes"}
...
![wood sample in substance designer](version-15-1.resources/version-15-1-04.png){zoomable="yes"}
...
![directionnal disorder noise](version-15-1.resources/version-15-1-05.gif){zoomable="yes"}
...
![node search with category 1](version-15-1.resources/version-15-1-06.png){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![node search with category 2](version-15-1.resources/version-15-1-07.png){zoomable="yes"}
...
<table>
  <tr>
    ...
    <td>
      <img src="version-15-1.resources/version-15-1-09.png" alt="With the default output, thumbnails are always relevant.">
      <br><i>After</i>
    </td>
  </tr>
</table>
...
![Is defined node](version-15-1.resources/version-15-1-10.png){zoomable="yes"}
