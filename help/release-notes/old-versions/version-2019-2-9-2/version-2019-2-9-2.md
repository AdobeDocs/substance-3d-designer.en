...
To read more about the Dot Node, see the [Graph items](../../../interface/the-graph-view/graph-items/graph-items.md) page.
...
All new [HDRI Tools](../../../compositing-graphs/nodes-reference-for-com/node-library/3d-view-library/hdri-tools/hdri-tools.md) are documented in the [Node Library section](../../../compositing-graphs/nodes-reference-for-com/node-library/node-library.md).
