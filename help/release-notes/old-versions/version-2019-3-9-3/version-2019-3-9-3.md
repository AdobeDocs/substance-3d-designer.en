...
For more information see the [Curvature from Mesh](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/curvature-from-mesh) documentation.
...
For more information see the [Ambient Occlusion from Mesh](https://experienceleague.adobe.com/en/docs/substance-3d/bakers/bakers-settings/ambient-occlusion-from-mesh) documentation.
