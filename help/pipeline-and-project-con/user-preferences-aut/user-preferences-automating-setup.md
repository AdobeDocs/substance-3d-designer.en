...
![XML file icon](user-preferences-automating-setup.resources/user-preferences-automating-setup-01.png "XML file icon")
...
![Project settings](user-preferences-automating-setup.resources/user-preferences-automating-setup-02.png "Project settings")
...
![Configuration file input in executable file properties](user-preferences-automating-setup.resources/user-preferences-automating-setup-03.jpg "Configuration file input in executable file properties")
