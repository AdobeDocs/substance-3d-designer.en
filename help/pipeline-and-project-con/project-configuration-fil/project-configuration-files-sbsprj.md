...
![SBSPRJ file icon](project-configuration-files-sbsprj.resources/project-configuration-files-sbsprj-01.png "SBSPRJ file icon")
...
![XML editing](project-configuration-files-sbsprj.resources/project-configuration-files-sbsprj-02.png "XML editing")
