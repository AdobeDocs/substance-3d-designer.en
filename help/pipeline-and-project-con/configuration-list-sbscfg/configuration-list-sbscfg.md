...
![SBSCFG file icon](configuration-list-sbscfg.resources/configuration-list-sbscfg-01.png "SBSCFG file icon")
...
![Project settings](configuration-list-sbscfg.resources/configuration-list-sbscfg-02.png "Project settings")
