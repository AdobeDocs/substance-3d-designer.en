...
![SBSCFG file icon](configuration-list-sbscfg.resources/sbscfg.png "SBSCFG file icon")
...
![Project settings](configuration-list-sbscfg.resources/config-ui.png "Project settings")
