...
![Settings up Python plugins search paths Project settings](plugin-search-paths.resources/plugin-search-paths-01.png "Settings up Python plugins search paths Project settings")
