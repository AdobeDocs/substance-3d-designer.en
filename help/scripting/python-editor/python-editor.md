...
![Find and replace in Python editor](../../assets/demo-pythoneditor-2.png "Find and replace in Python editor")
...
![Run selected code in Python editor](../../assets/demo-pythoneditor-3.png "Run selected code in Python editor")
