...
![Find and replace in Python editor](python-editor.resources/python-editor-02.png "Find and replace in Python editor")
...
![Run selected code in Python editor](python-editor.resources/python-editor-03.png "Run selected code in Python editor")
