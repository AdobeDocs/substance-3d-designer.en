...
![Frames in Substance graphs](graph-creation-etiquette.resources/frames.gif "Frames in Substance graphs")
...
![Input and output placement](graph-creation-etiquette.resources/inout.gif "Input and output placement")
...
![Link rerouting](graph-creation-etiquette.resources/linkjreroute.gif "Link rerouting")
...
![Identifier and label](graph-creation-etiquette.resources/output-label.png "Identifier and label")
...
![Identifier clarity](graph-creation-etiquette.resources/labelvsidentifier.png "Identifier clarity")
...
![Matching frame and parameter labels](graph-creation-etiquette.resources/match-labels.png "Matching frame and parameter labels")
...
![Color and grayscale conversions](graph-creation-etiquette.resources/colorgray01.png "Color and grayscale conversions")
