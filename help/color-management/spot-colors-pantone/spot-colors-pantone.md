...
1. Click the ![](../../assets/image2021-1-25-9-40-40.png) <b>Color picker type</b> button next to the RGB color swatch.
1. Instead of <b>RGB colors</b>, choose any <b>Color book</b> from the dropdown list.
1. The icon of the ![](../../assets/image2021-1-25-9-40-25.png) <b>Color picker type</b> changes, and its interface changes to <b>Spot color</b> mode.

![Switching to Spot color mode](../../assets/spot-switch.gif "Switching to Spot color mode"){width="512px"}

### Choosing and finding Spot Colors

There are a few ways to find and choose Spot colors within a color book.

* You can use the ![](../../assets/image2021-1-25-10-40-28.png) ![](../../assets/image2021-1-25-10-40-53.png) <b>Left and Right arrows</b> on either side of the book's pages to flip between pages. You can also click and drag on the page display to scroll between pages.
...
* To get a bigger, easier to use interface for the color book, click the color preview box between the ![](../../assets/image2021-1-25-10-39-18.png) <b>Eyedropper</b> icon  and the ![](../../assets/image2021-1-25-10-40-28.png) <b>Left arrow</b>.

![Browsing Spot colors](../../assets/spot-choose.gif "Browsing Spot colors"){width="512px"}

### Picking and Converting Spot Colors

Spot Colors can be picked using the ![](../../assets/image2021-1-25-10-39-18.png) <b>Eyedropper</b> tool. When in Spot Color mode this means the sampled RGB color will be converted to the closest matching Spot Color from the currently selected book.
...
![Picking and converting Spot colors](../../assets/spot-pick.gif "Picking and converting Spot colors"){width="512px"}
