...
![Bitmap painting tools in 2D View](bitmap-painting-tools.resources/2dview-paintingtools-main_1.png "Bitmap painting tools in 2D View"){width="512px"}
...
![New bitmap dialog](bitmap-painting-tools.resources/2dview-paintingtools-new-bitmap.png "New bitmap dialog"){width="512px"}
...
![](bitmap-painting-tools.resources/2dview-paintingtools-icon-colors-primary.png)![](bitmap-painting-tools.resources/2dview-paintingtools-icon-colors-secondary.png) <b>Color selection</b> <b>thumbnails:</b> Let you define a *primary* and *secondary* color. Click on any of these thumbnails to display the <b>Color editor</b> window and define a color. Tools will use the *primary* color. The primary and secondary colors can be *swapped* (<b>X</b>) at any time

![](bitmap-painting-tools.resources/2dview-paintingtools-icon-brush.png) <b>Brush tool (B):</b> Applies the *primary* color at the cursor location, when the pen tip or <b>LMB</b> button is pressed, using the options defined in the Tool options toolbar
...
![](bitmap-painting-tools.resources/2dview-paintingtools-clone-alignment.png) <b>Enable alignment (Stamp tool option):</b> Lets you define whether the source should *stay in place* when a new stamp begins, or if it should *relocate relatively to the new stamp location*

<b>![](bitmap-painting-tools.resources/2dview-paintingtools-icon-eraser.png) Eraser (E):</b> Replaces the current color of the image with the (0, 0, 0, 0) value at the cursor location, when the pen tip or <b>LMB</b> button is pressed, using the options defined in the Tool options toolbar. Make sure the [Transparency display](../../../interface/2d-view/2d-view.md) is enabled to keep track of the impact of this tool on the <b>Alpha</b> channel.
...
The ![](bitmap-painting-tools.resources/2dview-paintingtools-brush-thumb.png) <b>Brush selection</b> lets you select a *preconfigured* brush from the available brush *presets*, set its <b>Size</b> and <b>Hardness</b> *(*see <b>Shape</b> section of Brush editor), and displays a *preview* of a brush stroke.

Brush presets can be created and edited in the Brush editor and arranged in *libraries*. The brush presets which will appear in this panel is the *sum* of all loaded brush presets libraries. These librairies can be managed by accessing the ![](bitmap-painting-tools.resources/2dview-paintingtools-brushpresets-library.png) <b>Brush library</b> menu (see <b>Presets</b> section of Brush editor)

The ![](bitmap-painting-tools.resources/2dview-paintingtools-brushpresets-previewbkgd.png) <b>Select background color</b> button lets you change the background color of the *brush stroke preview*.

</td>
<td style="border: 0;" valign="top">

![Brush selection panel](bitmap-painting-tools.resources/2dview-paintingtools-brushes.png "Brush selection panel")
...
The ![](bitmap-painting-tools.resources/2dview-paintingtools-icon-brush-options.png) <b>Brush editor</b> gives access to granular options to define the behaviour of the brush:

<b>Presets</b>

Brushes can be customized then saved as a <b>Brush preset</b>, which will then be available in the ![](bitmap-painting-tools.resources/2dview-paintingtools-editor-currentpreset.png) <b>Brush presets list</b> and the ![](bitmap-painting-tools.resources/2dview-paintingtools-brush-thumb.png) <b>Brush selection</b> panel.

To create a preset, set the properties below to your liking, then click the ![](bitmap-painting-tools.resources/2dview-paintingtools-editor-addpreset.png) <b>Add brush preset </b>button and set a brush name in the <b>Preset name</b> window. The new preset is now automatically selected in the <b>Brush presets list</b>, and at any time you may ![](bitmap-painting-tools.resources/2dview-paintingtools-editor-updatepreset.png) <b>update</b> it with the new current settings, or ![](bitmap-painting-tools.resources/2dview-paintingtools-editor-deletepreset.png) <b>delete</b> it.

Presets are organised and saved in *libraries*, which can be managed in the ![](bitmap-painting-tools.resources/2dview-paintingtools-editor-presetlibrary.png) <b>Brush library</b> menu:
...
![Brush editor](bitmap-painting-tools.resources/2dview-paintingtools-brusheditor.png "Brush editor")
...
<b>Texture file: </b>defines the *path* of the bitmap which should be used as a brush texture. You can select the bitmap through your system file browser by using the ![](bitmap-painting-tools.resources/2dview-paintingtools-brusheditor-selecttexture.png) button next to the input field
...
![Opacity and flow controls](bitmap-painting-tools.resources/2dview-paintingtools-opacityflow.png "Opacity and flow controls")
...
The Brush, Stamp and Eraser tools also let you set their ![](bitmap-painting-tools.resources/2dview-paintingtools-icon-tiling.png) <b>Tiling modes</b>, which define their ability to *loop back around* to the opposite side of the image when a stroke impacts an area outside of the image's bounds:
...
![Tiling mode](bitmap-painting-tools.resources/2dview-paintingtools-tiling.png "Tiling mode")
