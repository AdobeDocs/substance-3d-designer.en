...
[Substance 3D Designer](https://www.adobe.com/products/substance3d-designer.html) is an application intended for creating 2D textures, materials and filters in a node-based interface, with a heavy focus on procedural generation, parameterization and non-destructive workflows. It is the longest-running application in the Substance 3D ecosystem and resources made with it are the most versatile and dynamic possible.
...
| **Author materials**                     | Yes                                                                                                                                                                                                                                                                                                                                                                          | Yes                                                                                                                                                                                                                                                                                                                              | Yes                                                                                                                                                                                                                                                                                                                                                                  |
| **Author 3D models**                     | No                                                                                                                                                                                                                                                                                                                                                                           | Limited\*                                                                                                                                                                                                                                                                                                                        | Limited\*                                                                                                                                                                                                                                                                                                                                                            |
| **Author filters, patterns and effects** | No                                                                                                                                                                                                                                                                                                                                                                           | Limited                                                                                                                                                                                                                                                                                                                          | Yes                                                                                                                                                                                                                                                                                                                                                                  |
...
It allows you to author content for almost any use case or scenario. It means you are not limited to a single type of output – such as a unique material/set of textures for a UV-mapped mesh – but can create content for a much more extended set of uses.
...
**[Non-linear](../../compositing-graphs/substance-compositing-graphs.md):** you can author a multitude of texture outputs at once. Edit one mask or slider, and automatically any connected output is re-calculated. No more need to separately author maps such as base color, roughness, normal, etc.

**[Non-destructive](../../compositing-graphs/compositing-graph-key-con/substance-compositing-graph-key-concepts.md):** you can reverse any action *without* losing any of your work. It becomes much quicker to iterate and experiment, finding even more efficient workflows.

**[Integrated baking](../../bakers/bakers.md):** access advanced, blazing-fast mesh baking tools right inside the software. You no longer have to perform baking in a separate software and perform lengthy import and export processes.

**[Parametric](../../compositing-graphs/manage-parameters/exposing-a-parameter/exposing-a-parameter.md):** you can set up to control nearly any aspect of a texture through a single slider or dropdown. This allows you to add endless control and variation to just a single asset.
