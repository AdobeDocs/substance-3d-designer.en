...
![Flip icon](./3d_sdf_transform_flip.png "Flip")
...
| <b>Mirror axis</b> *Integer3* | Use an <font color="#ffa96e">Integer3</font> to set the desired mirror axis.<br>E.g. (1, 0, 0) will mirror the X axis.<br><br><i>Default: (1, 0, 0)</i> |
