...
![Working with 3D scenes](working-with-3d-scenes.resources/workingWith3DScenes.png "Working with 3D scenes"){zoomable="yes"}
...
![Contents of a 3D scene](working-with-3d-scenes.resources/loaded3DScene.png "Contents of a 3D scene"){zoomable="yes"}
...
![Loading a 3D scene - From a 3D scene resource](working-with-3d-scenes.resources/load3DScene-3DSceneResource.gif "Loading a 3D scene - From a 3D scene resource"){zoomable="yes"}
...
![Loading a 3D scene - From the Library](working-with-3d-scenes.resources/load3DScene-Library.gif "Loading a 3D scene - From the Library"){zoomable="yes"}
...
![Loading a 3D scene - From a 3D scene file](working-with-3d-scenes.resources/load3DScene-3DSceneFile.gif "Loading a 3D scene - From a 3D scene file"){zoomable="yes"}
...
![Loading a 3D scene - From a scene state file](working-with-3d-scenes.resources/load3DScene-sceneStateFile.gif "Loading a 3D scene - From a scene state file"){zoomable="yes"}
...
![Scene browser - Elements created by Designer](working-with-3d-scenes.resources/sceneBrowser-createdByDesigner.png "Scene browser - Elements created by Designer"){zoomable="yes"}
...
![Load scene state file](working-with-3d-scenes.resources/loadSceneStateFile.gif "Load scene state file"){zoomable="yes"}
