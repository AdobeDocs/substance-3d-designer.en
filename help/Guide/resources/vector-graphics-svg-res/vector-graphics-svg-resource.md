---
title: "Vector graphics (SVG) resource | Substance 3D Designer"
description: "Designer > Resources > Vector graphics (SVG) resource"
---
...
SVG files [can be created or edited through the atomic SVG node,](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/svg/svg.md) they can also be created by [the UV to SVG baker.](../../../substance-3d-bake/bakers-settings/convert-uv-to-svg/convert-uv-to-svg.md)
