---
title: "Crash when rendering graphs | Substance 3D Designer"
description: "Designer > Technical issues > Crash when rendering graphs"
---
...
<b>&#91;!&#91;(error)&#93;(error.svg)&#93;(../../../substance-3d-painter/technical-support/technical-issues/gpu-issues/gpu-drivers-crash-with/gpu-drivers-crash-with-long-computations-tdr-crash.md) Issue</b>
...
The TDR timer values needs to be *increased* to prevent such crashes. You can do this by following the instructions in [this page](../../../substance-3d-painter/technical-support/technical-issues/gpu-issues/gpu-drivers-crash-with/gpu-drivers-crash-with-long-computations-tdr-crash.md) of Substance 3D Painter's documentation, which apply to Substance 3D Designer as well.
