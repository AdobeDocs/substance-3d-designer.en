---
title: "Gaussian spots 2 | Substance 3D Designer"
description: "Designer > Substance compositing graphs > Nodes reference for Substance compositing graphs > Node library > Texture Generators > Noises > Gaussian spots 2"
---
...
![Gaussian spots 2 - Icon](gaussian_spots_2.png "Gaussian spots 2 - Icon"){width="200px"}
...
![Gaussian spots 2 - Example 1](gaussian_spots_2.png "Gaussian spots 2 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Gaussian spots 2 - Example 2](noise_gaussian_spots_2_v2_speed0.6_aniso0.gif "Gaussian spots 2 - Example 2"){zoomable="yes"}
...
![Gaussian spots 2 - Example 3](noise_gaussian_spots_2_v2_speed0.6_aniso1.gif "Gaussian spots 2 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Gaussian spots 2 - Example 4](noise_gaussian_spots_2_v2_speed0.3_aniso0.6.gif "Gaussian spots 2 - Example 4"){zoomable="yes"}
