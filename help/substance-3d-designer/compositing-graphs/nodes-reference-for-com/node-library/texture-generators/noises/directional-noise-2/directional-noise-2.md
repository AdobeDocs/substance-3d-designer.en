---
title: "Directional noise 2 | Substance 3D Designer"
description: "Designer > Substance compositing graphs > Nodes reference for Substance compositing graphs > Node library > Texture Generators > Noises > Directional noise 2"
---
...
![Directional noise 2 - Icon](directional_noise_2.png "Directional noise 2 - Icon"){width="200px"}
...
![Directional noise 2 - Example 1](directional_noise_2.png "Directional noise 2 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 2 - Example 2](noise_directional_noise_2_v2_speed0.6_aniso0.gif "Directional noise 2 - Example 2"){zoomable="yes"}
...
![Directional noise 2 - Example 3](noise_directional_noise_2_v2_speed0.6_aniso1.gif "Directional noise 2 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 2 - Example 4](noise_directional_noise_2_v2_speed0.3_aniso0.6.gif "Directional noise 2 - Example 4"){zoomable="yes"}
