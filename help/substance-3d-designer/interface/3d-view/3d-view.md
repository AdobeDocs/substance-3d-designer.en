---
title: "3D view | Substance 3D Designer"
description: "Designer > Interface > 3D view"
---
...
> **TDR (Windows only)**
> 
> This feature requires that the <b>Timeout Detection and Recovery (TDR)</b> match the recommended values in [this page](../../../substance-3d-painter/technical-support/technical-issues/gpu-issues/gpu-drivers-crash-with/gpu-drivers-crash-with-long-computations-tdr-crash.md) of our documentation, as stated in Designer's [Technical requirements](../../getting-started/system-requirements/system-requirements.md).
