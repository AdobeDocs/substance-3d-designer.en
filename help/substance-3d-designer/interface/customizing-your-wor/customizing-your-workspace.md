---
title: "Customizing your workspace | Substance 3D Designer"
description: "Designer > Interface > Customizing your workspace"
---
...
This menu lets you manage the main user interface elements of Designer. Each option is described in the <b>Windows</b> section of [this page](https://helpx.adobe.com/content/help/en/substance-3d/unlisted/documentation/sddoc/the-main-menu-143720673.html) about the main toolbar. Here, we will provide additional concepts related to this menu.

### Display/Hide a view

In order to display or hide a specific interface item, click its name in the *Windows* menu. Displayed items have a ![](image2015-12-17-10-43-24.png) checkmark.
...
![Windows menu](windows-menu-1.png "Windows menu")
...
![Resizing docks](interface-customisation-resize.gif "Resizing docks")
...
![Moving docks](interface-customisation-move.gif "Moving docks")
...
![Tabbing docks](interface-customisation-tab.gif "Tabbing docks")
...
* Moving the dock using its *title bar* and placing it either *out of the main window* or on an area of the main window which is *not a dock*. You may redock this dock either by moving it on another dock *in the main window* or by clicking the <b>!&#91;&#93;(dock-icons-redock.png) Redock</b> button;
* Clicking the <b>!&#91;&#93;(dock-icons-undock.png) Undock</b> button. An dock undocked with this method may *only* be redocked by clicking the <b>!&#91;&#93;(dock-icons-redock.png) Redock</b> button.

![Undocking](interface-customisation-undock.gif "Undocking")
...
* Clicking their <b>!&#91;&#93;(dock-icons-maximise.png) Maximise</b> button
...
* Placing the *cursor over the dock* and pressing the <b>Shift+Space</b> keystroke
* Clicking their <b>!&#91;&#93;(dock-icons-minimise.png) Minimise</b> button
...
![Maximizing docks](interface-customisation-maximise.gif "Maximizing docks")
...
To pin a dock, click its ![](dock-icons-pin.png) <b>Pin</b> button. You can then *unpin* it using the ![](dock-icons-pinned.png) <b>Unpin</b> button to make it once more *available* to host any new content.
...
![Pinning docks](interface-customisation-pin.gif "Pinning docks")

## Closing docks

Any dock may be closed by clicing its ![](dock-icons-close.png) <b>Close</b> button.
...
![Reset layout](interface-customisation-reset.gif "Reset layout")
