...
![Custom content in Library](managing-custom-content-and-filters.resources/managing-custom-content-and-filters-01.png "Custom content in Library")
...
<b>![](managing-custom-content-and-filters.resources/managing-custom-content-and-filters-02.png) Add Folder:</b> Creates an expandable folder in the Library view. You *cannot* create subfolders.

<b>![](managing-custom-content-and-filters.resources/managing-custom-content-and-filters-03.png) Add Filter:</b> Adds a new Filter inside the selected folder. You *cannot* add filters to the existing default folders.

<b>![](managing-custom-content-and-filters.resources/managing-custom-content-and-filters-04.png) Edit Item:</b> Edits the currently selected Folder or Filter. You *cannot* edit any of the properties of the default Folders and Filters.
...
![Custom filter edition](managing-custom-content-and-filters.resources/managing-custom-content-and-filters-05.png "Custom filter edition")
