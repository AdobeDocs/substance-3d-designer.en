...
![Link creation mode: standard](../../../assets/link-creation-mode-standard.gif "Link creation mode: standard"){zoomable="yes"}
...
![Link creation mode: material](../../../assets/link-creation-mode-material.gif "Link creation mode: material"){zoomable="yes"}
...
![Link creation mode: compact material](../../../assets/link-creation-mode-compact-material.gif "Link creation mode: compact material"){zoomable="yes"}

*Click to enlarge*

![](../../../assets/image2020-10-6-19-40-46.png) <b>Compact Material</b> (3)
...
You can switch between modes at any moment in the graph toolbar by clicking on the ![](../../../assets/link-creation-mode.png) <b>Link creation mode</b> button or with the keyboard shortcuts listed above.
...
|  | <div><img data-preserve-html="true" height="23" src="../../../assets/image2020-10-6-19-40-25.png"/></div> Standard | <div><img data-preserve-html="true" height="23" src="../../../assets/image2020-10-6-17-11-20.png"/></div> Compact | <div><img data-preserve-html="true" height="23" src="../../../assets/image2020-10-6-19-40-46.png"/></div> Compact Material |
| --- | --- | --- | --- |
...
![Group capsule on node](../../../assets/link-creation-mode-group-node.png "Group capsule on node"){zoomable="yes"}
...
![Group attribute](../../../assets/link-creation-mode-group.png "Group attribute"){zoomable="yes"}
...
![Usage attribute](../../../assets/link-creation-mode-usage.png "Usage attribute"){zoomable="yes"}
