...
![Node finder toolbar](node-finder.resources/node-finder-toolbar.png "Node finder toolbar"){zoomable="yes"}
...
In the Graph View toolbar, click the <b>Node Finder button ![](node-finder.resources/graph-node-finder.png)</b> to display the Node Finder toolbar. Once displayed, the toolbar is only closed by clicking this button.
...
![Node finder: traversing graphs durig search](node-finder.resources/node-finder-traversal.gif "Node finder: traversing graphs durig search"){zoomable="yes"}

### Search query

![Node finder query field](node-finder.resources/node-finder-query-field.png "Node finder query field"){zoomable="yes"}
...
![Node type](node-finder.resources/node-finder-node-types.png "Node type"){zoomable="yes"}
...
![Node types (compositing)](node-finder.resources/node-finder-types-compositing.png "Node types (compositing)"){zoomable="yes"}



*Node types for compositing graphs*

![Node types (function)](node-finder.resources/node-finder-types-function.png "Node types (function)"){zoomable="yes"}
...
![Node finder: Searching by 'Levels' type (compositing)](node-finder.resources/node-finder-compositing-levels.png "Node finder: Searching by 'Levels' type (compositing)"){zoomable="yes"}
...
![Node finder: Searching by 'Instance' type (compositing)](node-finder.resources/node-finder-compositing-instances.png "Node finder: Searching by 'Instance' type (compositing)"){zoomable="yes"}



*Searching for the 'Instance' node type in a Substance graph*

![Node finder: Searching by 'Instance' type (function)](node-finder.resources/node-finder-functions-instances.png "Node finder: Searching by 'Instance' type (function)"){zoomable="yes"}
...
The <b>Search options button ![](node-finder.resources/node-finder-search-options.png)</b> opens a list of settings used for searching that can be toggled on and off.
...
![Node finder search options](node-finder.resources/node-finder-search-options-open.png "Node finder search options"){zoomable="yes"}
...
![Node finder: searching by graph identifier](node-finder.resources/node-finder-functions-identifier.png "Node finder: searching by graph identifier"){zoomable="yes"}
...
![Explorer: package contents](node-finder.resources/explorer-package-simple.png "Explorer: package contents"){zoomable="yes"}
...
![Graph identifier in instance node's tooltip](node-finder.resources/node-finder-compositing-identifier.png "Graph identifier in instance node's tooltip"){zoomable="yes"}
...
![Node finder query suggestions](node-finder.resources/node-finder-available-query-suggestions.png "Node finder query suggestions"){zoomable="yes"}
...
![Node finder: exposed parameters](node-finder.resources/node-finder-compositing-exposed-parameter.png "Node finder: exposed parameters"){zoomable="yes"}
...
![Node finder: searching variable from Console warning/error](node-finder.resources/node-finder-console-identifier.png "Node finder: searching variable from Console warning/error"){zoomable="yes"}
...
![Node finder: Searching a variable matches Get nodes using it](node-finder.resources/node-finder-exposed-parameter-01.gif "Node finder: Searching a variable matches Get nodes using it"){zoomable="yes"}
...
![Node finder: copy node UID action](node-finder.resources/node-finder-compositing-uid-copy.png "Node finder: copy node UID action"){zoomable="yes"}
...
![Node finder: Searching node UID from the Console](node-finder.resources/node-finder-console-uid.png "Node finder: Searching node UID from the Console"){zoomable="yes"}
...
The <b>Search options button ![](node-finder.resources/node-finder-search-options.png)</b> lets you toggle the <b>recursive</b> and <b>fuzzy</b> modes for searching nodes.
...
![Node finder: recursive search](node-finder.resources/node-finder-recursion-01.png "Node finder: recursive search"){zoomable="yes"}
...
+++Example 1
![Node finder: recursive search example 1](node-finder.resources/node-finder-recursion-01.gif "Node finder: recursive search example 1"){zoomable="yes"}
...
+++Example 2
![Node finder: recursive search example 2](node-finder.resources/node-finder-recursion-02.gif "Node finder: recursive search example 2"){zoomable="yes"}
...
![Node finder: Fuzzy mode](node-finder.resources/node-finder-functions-fuzzy.png "Node finder: Fuzzy mode"){zoomable="yes"}
