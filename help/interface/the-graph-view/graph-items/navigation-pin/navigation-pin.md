...
![Navigation pin icon](navigation-pin.resources/navigation-pin-01.png "Navigation pin icon")
...
>[!TIP]
>
> When a pin is created, its 'Description' property automatically gains focus so you can immediately edit the pin's text.
...
![Pins: Jumping to pins](navigation-pin.resources/navigation-pin-02.gif "Pins: Jumping to pins")
