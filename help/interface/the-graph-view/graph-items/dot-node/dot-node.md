...
![Dot node icon](dot-node.resources/graphatomic-dot_1.png "Dot node icon")
...
![Inserting a Dot node](dot-node.resources/dot-node-insert-optim.gif "Inserting a Dot node"){width="512px"}
...
![Dot: Creating from connector](dot-node.resources/graph-dot_create-from-connector.gif "Dot: Creating from connector")
...
![Dot node in Node menu](dot-node.resources/dot-node-insert-menu.png "Dot node in Node menu")
...
![Merging links](dot-node.resources/dot-node-congrenate-links-optim.gif "Merging links"){width="512px"}
...
![Dot node as portal - icon](dot-node.resources/DotNode_Portal-1.png "Dot node as portal - icon")
...
![Dot node as portal](dot-node.resources/DotNode_Portal.gif "Dot node as portal")
