...
![Dot node icon](dot-node.resources/dot-node-01.png "Dot node icon")
...
![Inserting a Dot node](dot-node.resources/dot-node-02.gif "Inserting a Dot node"){width="512px"}
...
![Dot: Creating from connector](dot-node.resources/dot-node-03.gif "Dot: Creating from connector")
...
![Dot node in Node menu](dot-node.resources/dot-node-04.png "Dot node in Node menu")
...
![Merging links](dot-node.resources/dot-node-05.gif "Merging links"){width="512px"}
...
![Dot node as portal - icon](dot-node.resources/dot-node-06.png "Dot node as portal - icon")
...
![Dot node as portal](dot-node.resources/dot-node-07.gif "Dot node as portal")
