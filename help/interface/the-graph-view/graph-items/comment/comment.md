...
![Comment icon](comment.resources/comment-01.png "Comment icon")
...
![Comments: Parented comments](comment.resources/comment-02.gif "Comments: Parented comments")
...
Text can be formatted using HTML tags. This formatting is toggled using the ![](comment.resources/comment-03.png) <b>HTML markup</b> button in the comment's <b>Description</b> property.
...
![Comments: HTML markup](comment.resources/comment-04.gif "Comments: HTML markup")
