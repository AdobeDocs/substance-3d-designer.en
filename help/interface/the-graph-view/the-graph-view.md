...
![Placing nodes](the-graph-view.resources/the-graph-view-02.gif "Placing nodes")
...
![Graph View: Node menu](the-graph-view.resources/the-graph-view-03.png "Graph View: Node menu")
...
![Selecting nodes](the-graph-view.resources/the-graph-view-04.gif "Selecting nodes")
...
![Connecting nodes](the-graph-view.resources/the-graph-view-05.gif "Connecting nodes")
...
* They are displayed with the ![](the-graph-view.resources/the-graph-view-06.png)&nbsp;&nbsp;<b>Disabled</b> badge*,*a *dashed outline*, and an interior *rerouting* link instead of a thumbnail;
...
![Disabling nodes](the-graph-view.resources/the-graph-view-07.gif "Disabling nodes"){width="512px"}
...
![](the-graph-view.resources/the-graph-view-08.png)&nbsp;&nbsp;<b>Focus selection</b> (F)  
Focus view on selection, or whole scene if selection is empty.

![](the-graph-view.resources/the-graph-view-09.png)&nbsp;&nbsp;<b>Reset zoom</b> (Z)  
...
![](the-graph-view.resources/the-graph-view-10.png)&nbsp;&nbsp;<b>Export Graph view  
</b>Exports the full graph at a 1:1 resolution as an image. Useful for sharing a screenshot of your entire graph.

![](the-graph-view.resources/the-graph-view-11.png)&nbsp;&nbsp;<b>Node information  
...
![](the-graph-view.resources/the-graph-view-12.png)<b> Node finder</b> (Ctrl+F)  
...
![](the-graph-view.resources/the-graph-view-13.png)&nbsp;&nbsp;<b>Highlight flow  
...
![](the-graph-view.resources/the-graph-view-15.png)&nbsp;&nbsp;<b>Rectangle links  
...
![](the-graph-view.resources/the-graph-view-16.png)&nbsp;&nbsp;<b>Node alignment tools  
...
![](the-graph-view.resources/the-graph-view-17.png)&nbsp;&nbsp;<b>Parent size  
</b>Toggles display of the Parent Resolution control settings, see below.

![](the-graph-view.resources/the-graph-view-18.png)&nbsp;&nbsp;<b>Link Creation Modes</b> (1, 2, 3)  
...
![](the-graph-view.resources/the-graph-view-19.png)&nbsp;&nbsp;<b>Timings control  
...
![](the-graph-view.resources/the-graph-view-21.png)&nbsp;&nbsp;<b>Node image cache  
</b>Toggles display of the node image cache toggle, see below.

![](the-graph-view.resources/the-graph-view-22.jpg) Remove unused nodes  
...
![Graph items palette](the-graph-view.resources/the-graph-view-24.png "Graph items palette")<br>
...
![Parent size toolbar](the-graph-view.resources/the-graph-view-26.png "Parent size toolbar")
...
![Node image cache setting](the-graph-view.resources/the-graph-view-27.png "Node image cache setting")
...
![Remove unused nodes drop down menu](the-graph-view.resources/the-graph-view-28.jpg "Remove unused nodes drop down menu")
