...
![2D View](2d-view.resources/2d-view-01.png "2D View")
...
*Multiple* 2D View panels can be active at any time, and each can display different images or values. You can control when a new panel should be used by using the ![](2d-view.resources/2d-view-02.png) <b>Pin</b> feature of the user interface panel.
...
* <b>Adjust to fit viewport:</b> F / 'Fit to view' button ![](2d-view.resources/2d-view-04.png)
* <b>Adjust to 1:1 scale:</b> Z / 'Fit to scale' button ![](2d-view.resources/2d-view-05.png)

</td>
<td style="border: 0;" valign="top">

![2D View viewport navigation](2d-view.resources/2d-view-06.gif "2D View viewport navigation")
...
* Tiled display: *repeats the image* in the viewport in a tiled pattern. This is useful for checking how a pattern or texture will repeat. It is enabled using the **Space bar** or ![](2d-view.resources/2d-view-07.png) **Tiled display** button
* Physical size display: Displays the image with a *ratio* matching the [Physical size](../../compositing-graphs/graph-parameters/graph-parameters.md) property of the graph It is enabled using the ![](2d-view.resources/2d-view-08.png) **Physical size ratio** button
* Keep view size: This option *locks the display scale* so it stays consistent throughout different images. It is *enabled by default* and can be disabled using the ![](2d-view.resources/2d-view-09.png) **Keep view size** button
...
+++Background image
![2D View background image](2d-view.resources/2d-view-10.png "2D View background image"){width="360px"}



You can *overlay a different image* on top of the currently displayed one. Press the ![](2d-view.resources/2d-view-11.png) <b>Background Image</b> button and you will be prompted to select an image file to use as an overlay.

Once the file is selected, a new toolbar appears with the following controls for the image overlay:

<b>![](2d-view.resources/2d-view-12.png) Close:</b> *close* the overlay controls toolbar and *disable* the background image overlay.

<b>![](2d-view.resources/2d-view-13.png) Load image:</b> select *another image file* to use as an overlay.

<b>![](2d-view.resources/2d-view-14.png) Source image:</b> sets the overlay image to *0%* opacity.

<b>![](2d-view.resources/2d-view-15.png) Background image:</b> sets the overlay image to *100%* opacity.

<b>![](2d-view.resources/2d-view-16.png) Reset:</b> sets the overlay image to *50%* opacity.
...
+++Export image
![2D View export image](2d-view.resources/2d-view-17.png "2D View export image"){width="360px"}



The image currently displayed can be *exported to an image file*. Press the ![](2d-view.resources/2d-view-18.png) <b>Save Image...</b> button and you will be prompted to select an *location*, *name* and *file format* for the exported file.
...
+++Copy to clipboard
![2D View copy to clipboard](2d-view.resources/2d-view-19.gif "2D View copy to clipboard"){width="360px"}



The image currently displayed can be *copied to the clipboard*. Press the ![](2d-view.resources/2d-view-20.png) <b>Copy Image to Clipboard</b> button and the image will be ready to be pasted into any third party software, such as Adobe Photoshop.
...
![2D View switch graph outputs](2d-view.resources/2d-view-21.gif "2D View switch graph outputs"){width="360px"}



If the image currently displayed is a *graph output*, you can *quickly switch to any* other graph output using the ![](2d-view.resources/2d-view-22.png) <b>Select output</b> button.
...
+++UV overlay
![2D View UV overlay](2d-view.resources/2d-view-23.png "2D View UV overlay"){width="357px"}
...
You can enable it using the <b>UV</b> button. ![](2d-view.resources/2d-view-24.png)
...
+++Histogram
![2D View histogram](2d-view.resources/2d-view-27.png "2D View histogram"){width="360px"}



You can display the *histogram* of the image with the <b>Histogram</b> panel, which is enabled using the ![](2d-view.resources/2d-view-28.png) <b>Display Histogram</b> button.
...
![2D View transparency toggle](2d-view.resources/2d-view-31.png "2D View transparency toggle"){width="360px"}

### Transparency toggle

Transparency display can be toggled on and off, using the ![](2d-view.resources/2d-view-32.png)/![](2d-view.resources/2d-view-33.png) <b>Show checkerboard</b> button. When this is enabled, transparency is displayed using a checkerboard pattern.

There are two main ways to interpret transparency, which can be selected using the ![](2d-view.resources/2d-view-34.png)/![](2d-view.resources/2d-view-35.png) <b>Transparency mode</b> button:

<b>![](2d-view.resources/2d-view-34.png) Straight:</b> transparency information is only stored in the alpha channel, and does not impact any other aspect of the image

<b>![](2d-view.resources/2d-view-35.png) Premultiplied:</b> transparency information is stored in the alpha channel, and also impacts the RGB channels since they are effectively multiplied against the alpha channel
...
![2D View color space](2d-view.resources/2d-view-36.png "2D View color space"){width="360px"}
...
![2D View bitmap painting tools](2d-view.resources/2d-view-39.png "2D View bitmap painting tools")
...
![2D View vector graphics editor](2d-view.resources/2d-view-40.png "2D View vector graphics editor")
...
![2D View color management](2d-view.resources/2d-view-41.png "2D View color management"){width="360px"}
...
* <b>Legacy:</b> you can disp.lay the image in the ![](2d-view.resources/2d-view-37.png) sRGB or ![](2d-view.resources/2d-view-38.png) Linear sRGB color spaces;
* <b>Adobe ACE:</b> you can ![](2d-view.resources/2d-view-37.png) *enable* color management and set the most appropriate color space for the *current monitor* as detected by the Adobe ACE engine, or ![](2d-view.resources/2d-view-38.png) *disable* color management and display the image using the Raw color values;
* <b>OCIO:</b> you can ![](2d-view.resources/2d-view-37.png) *enable* color management and set the most appropriate one for the *current monitor* as detected by the OCIO engine, use the combo box and select any of the *display color spaces* available in the [OCIO configuration file](../../color-management/color-management.md) currently used, or ![](2d-view.resources/2d-view-38.png) *disable* color management and display the image using the Raw color values.
