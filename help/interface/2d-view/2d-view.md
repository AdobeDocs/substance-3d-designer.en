...
![2D View](../../assets/2d-view-main.png "2D View")
...
*Multiple* 2D View panels can be active at any time, and each can display different images or values. You can control when a new panel should be used by using the ![](../../assets/2d-view-icon-pin.png) <b>Pin</b> feature of the user interface panel.
...
![2D View viewport navigation](../../assets/2d-view-viewport-navigation.gif "2D View viewport navigation")
...
* Tiled display: *repeats the image* in the viewport in a tiled pattern. This is useful for checking how a pattern or texture will repeat. It is enabled using the **Space bar** or ![](../../assets/2d-view-icon-tiling.png) **Tiled display** button
* Physical size display: Displays the image with a *ratio* matching the [Physical size](../../compositing-graphs/graph-parameters/graph-parameters.md) property of the graph It is enabled using the ![](../../assets/2d-view-icon-physical-size.png) **Physical size ratio** button
* Keep view size: This option *locks the display scale* so it stays consistent throughout different images. It is *enabled by default* and can be disabled using the ![](../../assets/2d-view-icon-lock-scale.png) **Keep view size** button
...
+++Background image
![2D View background image](../../assets/2d-view-background.png "2D View background image"){width="360px"}



You can *overlay a different image* on top of the currently displayed one. Press the ![](../../assets/2d-view-icon-background.png) <b>Background Image</b> button and you will be prompted to select an image file to use as an overlay.
...
+++Export image
![2D View export image](../../assets/2d-view-export-bitmap.png "2D View export image"){width="360px"}



The image currently displayed can be *exported to an image file*. Press the ![](../../assets/2d-view-icon-export.png) <b>Save Image...</b> button and you will be prompted to select an *location*, *name* and *file format* for the exported file.
...
+++Copy to clipboard
![2D View copy to clipboard](../../assets/2d-view-copy-clipboard.gif "2D View copy to clipboard"){width="360px"}



The image currently displayed can be *copied to the clipboard*. Press the ![](../../assets/2d-view-icon-copy.png) <b>Copy Image to Clipboard</b> button and the image will be ready to be pasted into any third party software, such as Adobe Photoshop.
...
![2D View switch graph outputs](../../assets/2d-view-switch-graph-outputs.gif "2D View switch graph outputs"){width="360px"}



If the image currently displayed is a *graph output*, you can *quickly switch to any* other graph output using the ![](../../assets/2d-view-icon-view-outputs.png) <b>Select output</b> button.
...
+++UV overlay
![2D View UV overlay](../../assets/2d-view-uv.png "2D View UV overlay"){width="357px"}
...
+++Histogram
![2D View histogram](../../assets/2d-view-histogram.png "2D View histogram"){width="360px"}



You can display the *histogram* of the image with the <b>Histogram</b> panel, which is enabled using the ![](../../assets/2d-view-icon-histogram.png) <b>Display Histogram</b> button.
...
![2D View color channels](../../assets/2d-view-color-channel.png "2D View color channels"){width="360px"}
...
![2D View transparency toggle](../../assets/2d-view-transparency.png "2D View transparency toggle"){width="360px"}

### Transparency toggle

Transparency display can be toggled on and off, using the ![](../../assets/2d-view-icon-transparency-off.png)/![](../../assets/2d-view-icon-transparency-on.png) <b>Show checkerboard</b> button. When this is enabled, transparency is displayed using a checkerboard pattern.
...
![2D View vector graphics editor](../../assets/2dview-vectorediting-main.png "2D View vector graphics editor")
