...
![Inheritance methods](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-01.jpg "Inheritance methods"){width="1400px"}
...
![Icon for 'Absolute' inheritance method](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-02.png "Icon for 'Absolute' inheritance method"){width="128px"}
...
![Icon for 'Relative to input' inheritance method](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-03.png "Icon for 'Relative to input' inheritance method"){width="128px"}
...
![Icon for 'Relative to parent' inheritance method](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-04.png "Icon for 'Relative to parent' inheritance method"){width="128px"}
...
![Inheritance methods demonstration](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-05.gif "Inheritance methods demonstration")
...
>[!NOTE]
>
> **Output size:** Use the ![](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-06.jpg) lock button to have the Height value *match* the Width value  
> **Random seed:** Use the ![](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-07.jpg) button to assign a new random value to the random seed.
...
![Changing inheritance method](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-08.gif "Changing inheritance method"){width="512px"}
...
![Primary input color/grayscale](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-09.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![Primary input color](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-10.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![Primary input grayscale](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-11.png){width="48px"}
...
![Input connector types](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-12.jpg "Input connector types")
...
![Inheritance diagram A](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-13.png "Inheritance diagram A"){zoomable="yes"}
...
![Inheritance diagram B](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-14.png "Inheritance diagram B"){zoomable="yes"}
...
![Inheritance diagram C](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-15.png "Inheritance diagram C"){zoomable="yes"}
...
![Inheritance diagram D](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-16.png "Inheritance diagram D"){zoomable="yes"}
...
![Output size inheritance](inheritance-in-substance-compositing-graphs.resources/inheritance-in-substance-compositing-graphs-17.jpg "Output size inheritance"){width="512px"}
