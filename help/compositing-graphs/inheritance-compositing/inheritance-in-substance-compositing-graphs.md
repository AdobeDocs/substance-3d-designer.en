...
![Inheritance methods](inheritance-in-substance-compositing-graphs.resources/inheritance-overview-1.jpg "Inheritance methods"){width="1400px"}
...
![Icon for 'Absolute' inheritance method](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-absolute.png "Icon for 'Absolute' inheritance method"){width="128px"}
...
![Icon for 'Relative to input' inheritance method](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-relative-to-input.png "Icon for 'Relative to input' inheritance method"){width="128px"}
...
![Icon for 'Relative to parent' inheritance method](inheritance-in-substance-compositing-graphs.resources/ds-inheritance-relative-to-parent.png "Icon for 'Relative to parent' inheritance method"){width="128px"}
...
![Inheritance methods demonstration](inheritance-in-substance-compositing-graphs.resources/inheritance-overview.gif "Inheritance methods demonstration")
...
>[!NOTE]
>
> **Output size:** Use the ![](inheritance-in-substance-compositing-graphs.resources/props-output-size-lock.jpg) lock button to have the Height value *match* the Width value  
> **Random seed:** Use the ![](inheritance-in-substance-compositing-graphs.resources/prop-randomise.jpg) button to assign a new random value to the random seed.
...
![Changing inheritance method](inheritance-in-substance-compositing-graphs.resources/inheritance-change.gif "Changing inheritance method"){width="512px"}
...
![Primary input color/grayscale](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-both.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![Primary input color](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-color.png){width="48px"}

</td>
<td style="border: 0;" valign="top">

![Primary input grayscale](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input-grayscale.png){width="48px"}
...
![Input connector types](inheritance-in-substance-compositing-graphs.resources/inheritance-primary-input.jpg "Input connector types")
...
![Inheritance diagram A](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-a.png "Inheritance diagram A"){zoomable="yes"}
...
![Inheritance diagram B](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-b.png "Inheritance diagram B"){zoomable="yes"}
...
![Inheritance diagram C](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-c.png "Inheritance diagram C"){zoomable="yes"}
...
![Inheritance diagram D](inheritance-in-substance-compositing-graphs.resources/inheritance-schematic-d.png "Inheritance diagram D"){zoomable="yes"}
...
![Output size inheritance](inheritance-in-substance-compositing-graphs.resources/inheritance-blend.jpg "Output size inheritance"){width="512px"}
