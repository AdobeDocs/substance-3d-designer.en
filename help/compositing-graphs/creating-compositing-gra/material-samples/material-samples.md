...
![Material samples - Template cards](materialSamples-cards.png "Material samples - Template cards")
...
When creating a new Substance graph, you will find the samples in the [New Substance graph dialog](../../../help/compositing-graphs/creating-compositing-gra/creating-a-substance-compositing-graph.md):

<table>
<tr style="border: 0;">
<td style="border: 0;" valign="top">

![New Substance graph dialog - Material samples](newGraphDialog-samples-1.png "New Substance graph dialog - Material samples"){zoomable="yes"}
...
![Material samples - Banner button](materialSamples-bannerButton.png "Material samples - Banner button"){zoomable="yes"}
...
![Material samples - Template card tooltip](newGraphDialog-sampleTooltip.png "Material samples - Template card tooltip"){zoomable="yes"}
...
By default, the first output of the sample is loaded in the 2D View, and the textures are applied to the 3D View. So your workspace is automatically set up and you are ready to go. (This can be changed in Designer's [preferences](../../../help/interface/preferences-window/preferences-window.md))
