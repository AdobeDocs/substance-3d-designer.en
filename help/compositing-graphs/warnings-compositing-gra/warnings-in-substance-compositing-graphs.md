...
## ![(error)](warnings-in-substance-compositing-graphs.resources/error.svg) No output node defined

The graph does not have an [Output](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md) node.

**![(tick)](warnings-in-substance-compositing-graphs.resources/check.svg) Solution**
