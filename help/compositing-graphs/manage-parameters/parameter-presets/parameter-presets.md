...
![Load/Save preset drop down menu](parameter-presets.resources/parameter-presets-01.gif "Load/Save preset drop down menu"){width="512px"}
...
![Embedded presets editing](parameter-presets.resources/parameter-presets-02.gif "Embedded presets editing"){width="512px"}
