...
![Global 'Manage parameters' menu in Properties](manage-parameters.resources/manage-parameters-01.png "Global 'Manage parameters' menu in Properties"){zoomable="yes"}
...
![Local 'Manage parameters' menu in Properties](manage-parameters.resources/manage-parameters-02.png "Local 'Manage parameters' menu in Properties"){zoomable="yes"}
...
!['Manage parameters' menu in node contextual menu](manage-parameters.resources/manage-parameters-03.png "'Manage parameters' menu in node contextual menu"){zoomable="yes"}
...
![Copy and paste parameters](manage-parameters.resources/manage-parameters-04.gif "Copy and paste parameters"){zoomable="yes"}
