...
![Atomic node: Gradient map](gradient-map.resources/gradient-map-01.png "Atomic node: Gradient map"){width="200px"}
...
![Gradient Editor](gradient-map.resources/gradient-map-02.png "Gradient Editor")
...
![Gradient Editor - Gradient view](gradient-map.resources/gradient-map-03.png "Gradient Editor - Gradient view")
...
![Gradient Editor - Add pin](gradient-map.resources/gradient-map-04.gif "Gradient Editor - Add pin")
...
![Gradient Editor - Pin position parameter](gradient-map.resources/gradient-map-05.png "Gradient Editor - Pin position parameter")

</td>
<td style="border: 0;" valign="top">

![Gradient Editor - Move pin](gradient-map.resources/gradient-map-06.gif "Gradient Editor - Move pin")
...
![Gradient Editor - Delete pin](gradient-map.resources/gradient-map-07.gif "Gradient Editor - Delete pin")
...
![Gradient editor: Invert positions](gradient-map.resources/gradient-map-08.gif "Gradient editor: Invert positions")
...
![Gradient Editor - Clear all](gradient-map.resources/gradient-map-09.gif "Gradient Editor - Clear all")
...
![Gradient Editor - Color picker](gradient-map.resources/gradient-map-10.png "Gradient Editor - Color picker")
...
* <b>Gradient and hue bar</b>
  ...
  ![Color Picker - Gradient area and hue bar](gradient-map.resources/gradient-map-11.gif "Color Picker - Gradient area and hue bar")
...
* <b>RGB, HSV, and Alpha sliders</b>
  ...
  ![Color Picker - RGB, HSV and Alpha sliders](gradient-map.resources/gradient-map-12.png "Color Picker - RGB, HSV and Alpha sliders")
...
* <b>Pick on screen</b>
  ...
  ![Color Picker - Pick on screen](gradient-map.resources/gradient-map-13.gif "Color Picker - Pick on screen")
...
![Color Picker - Revert color](gradient-map.resources/gradient-map-14.png "Color Picker - Revert color")
...
![Color Picker - Buttons](gradient-map.resources/gradient-map-15.gif "Color Picker - Buttons")
...
![Gradient Editor - Gradient Picker](gradient-map.resources/gradient-map-16.gif "Gradient Editor - Gradient Picker")
