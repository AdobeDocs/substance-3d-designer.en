...
![Atomic node: Input value](input-value.resources/comp_inputnumeric_1.png "Atomic node: Input value")
...
![Primary input in Substance graph](input-value.resources/node-primary-input.png)
