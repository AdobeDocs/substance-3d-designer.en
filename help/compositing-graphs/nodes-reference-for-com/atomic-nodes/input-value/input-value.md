...
breadcrumb-title: ""
description: Use the Input value node to create value input parameters for Substance graphs that can be exposed and adjusted by users.
...
![Atomic node: Input value](input-value.resources/comp_inputnumeric_1.png "Atomic node: Input value"){width="20%"}
...
See also: [Input color](../input-color/input-color.md), [Input grayscale](../input-grayscale/input-grayscale.md)

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-value.resources/input-value-tooltip.gif" alt="Input value tooltip" /></div>
...
![Primary input in Substance graph](input-value.resources/node-primary-input.png){width="20%"}
...
Inputs are not directly sent to the 3D View, but their Usage Attributes are used by [Substance 3D Painter](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/home) for automatically filling slots with certain maps (mostly used with [Filters](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/effects/filter)).
