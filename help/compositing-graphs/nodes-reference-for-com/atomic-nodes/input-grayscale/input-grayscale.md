...
breadcrumb-title: ""
description: Use the Input grayscale node to create grayscale input parameters for Substance graphs that can be exposed and adjusted by users.
...
See also: [Input color](../input-color/input-color.md), [Input value](../input-value/input-value.md)
...
<td style="border: 0; text-align: center" align="center"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="Input grayscale tooltip" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
