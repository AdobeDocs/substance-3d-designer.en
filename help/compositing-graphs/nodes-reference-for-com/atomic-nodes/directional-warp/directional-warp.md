...
![Atomic node: Directional warp](directional-warp.resources/directional-warp-01.png "Atomic node: Directional warp"){width="200px"}
...
![Directional Warp - Example 1](directional-warp.resources/directional-warp-02.gif "Directional Warp - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional Warp - Example 2](directional-warp.resources/directional-warp-03.gif "Directional Warp - Example 2"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional Warp - Example 3](directional-warp.resources/directional-warp-04.gif "Directional Warp - Example 3"){zoomable="yes"}
