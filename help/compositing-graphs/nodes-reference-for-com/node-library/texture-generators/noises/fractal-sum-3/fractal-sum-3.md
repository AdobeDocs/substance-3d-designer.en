...
![Fractal sum 3 - Icon](fractal-sum-3.resources/fractal-sum-3-01.png "Fractal sum 3 - Icon"){width="200px"}
...
![Fractal sum 3 - Example 1](fractal-sum-3.resources/fractal-sum-3-02.png "Fractal sum 3 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fractal sum 3 - Example 2](fractal-sum-3.resources/fractal-sum-3-03.gif "Fractal sum 3 - Example 2"){zoomable="yes"}
