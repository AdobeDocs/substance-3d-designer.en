...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fractal-sum-3.resources/fractal_sum_3_1.png" class="modal-image" alt="Fractal sum 3 - Example 1" />
        </td>
        <td style="border: 0;">
            <img src="fractal-sum-3.resources/noise_fractal_sum_3_v2_speed0.6_aniso0.gif" class="modal-image" alt="Fractal sum 3 - Example 2" />
        </td>
