...
The <b>3D Ridged Noise Fractal</b> node generates a <i>fractal</i> Ridged noise in 3D space based on the <b>Position Map</b> input.
...
| <b>Scale</b> <i>Float</i> | Controls the scale of the fractal 3D Ridged noise. |
| <b>Size</b> <i>Float3</i> | Controls the size of the fractal 3D Ridged noise in the <b>X</b>, <b>Y</b> and <b>Z</b> axes. Non-uniform values result in a <i>stretching or squashing</i> effect. |
| <b>Offset</b> <i>Float3</i> | Applies an offset to the <i>position</i> of the fractal 3D Ridged noise in the <b>X</b>, <b>Y</b> and <b>Z</b> axes. |
| <b>Distortion Intensity</b> <i>Float</i> | Controls the intensity of a <i>warping effect</i> applied on the fractal 3D Ridged noise. |
...
| <b>Global Opacity</b> <i>Float</i> | Controls the <i>range</i> of the fractal 3D Ridged noise values <i>around</i> the <b>Baseline</b> value. |
| <b>Baseline</b> <i>Float</i> | Applies an <i>offset</i> to the baseline <i>luminance</i> value for the 3D Ridged noise value distribution. |
| <b>Contrast</b> <i>Float</i> | Adjusts the contrast of the 3D Ridged noise. |
| <b>Enable Tiling</b> <i>Boolean</i> | Adjusts the 3D Ridged noise so its resulting pattern <i>repeats</i> in the X, Y and Z axes. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant.jpg" class="modal-image" alt="3D Ridged Noise Fractal - Example 1" />
        </td>
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant2.jpg" class="modal-image" alt="3D Ridged Noise Fractal - Example 2" />
        </td>
