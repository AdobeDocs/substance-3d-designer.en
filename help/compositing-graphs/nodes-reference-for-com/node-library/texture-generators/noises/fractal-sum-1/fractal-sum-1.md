...
![Fractal sum 1 - Icon](fractal-sum-1.resources/fractal-sum-1-01.png "Fractal sum 1 - Icon"){width="200px"}
...
![Fractal sum 1 - Example 1](fractal-sum-1.resources/fractal-sum-1-02.png "Fractal sum 1 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Fractal sum 1 - Example 2](fractal-sum-1.resources/fractal-sum-1-03.gif "Fractal sum 1 - Example 2"){zoomable="yes"}
