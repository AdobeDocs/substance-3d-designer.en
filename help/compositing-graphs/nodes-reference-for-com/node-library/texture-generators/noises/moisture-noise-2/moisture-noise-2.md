...
![Moisture noise 2 - Icon](moisture-noise-2.resources/moisture-noise-2-01.png "Moisture noise 2 - Icon"){width="200px"}
...
See also: [Moisture noise 1](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/moisture-noise/moisture-noise.md)
...
| <b>Pattern size</b> <i>Float2</i> | A multiplier for the size of a scattered pattern., where 1.0 is its original scaterring size. |
| <b>Pattern angle</b> <i>Float</i> | The angle used to set the direction of the scattered pattern, in number of turns and starting from horizontal right. |
| <b>Pattern angle random</b> <i>Float</i> | The maximum amout of random variation applied to the <b>Pattern angle</b> value, in number of turns. |
| <b>Global opacity</b> <i>Float</i> | The opacity of all ingredients of the noise, where 0.0 results in a base flat gray and 1.0 is the result of the full addition or subtraction applied by the ingredients. |
...
![Moisture noise 2 - Example 1](moisture-noise-2.resources/moisture-noise-2-02.png "Moisture noise 2 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Moisture noise 2 - Example 2](moisture-noise-2.resources/moisture-noise-2-03.gif "Moisture noise 2 - Example 2"){zoomable="yes"}
...
![Moisture noise 2 - Example 3](moisture-noise-2.resources/moisture-noise-2-04.gif "Moisture noise 2 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Moisture noise 2 - Example 4](moisture-noise-2.resources/moisture-noise-2-05.gif "Moisture noise 2 - Example 4"){zoomable="yes"}
