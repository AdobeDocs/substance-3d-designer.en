...
breadcrumb-title: ""
description: Use the Dirt 3 node to generate intermediate dirt patterns for creating weathered surface details and accumulation effects.
...
![Dirt 3 - Icon](dirt-3.resources/dirt_3.png "Dirt 3 - Icon"){width="200px"}
...
![Dirt 3 - Example 1](dirt-3.resources/dirt_3_1.png "Dirt 3 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 3 - Example 2](dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso0.gif "Dirt 3 - Example 2"){zoomable="yes"}
...
![Dirt 3 - Example 3](dirt-3.resources/noise_dirt_3_v2_speed0.6_aniso1.gif "Dirt 3 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Dirt 3 - Example 4](dirt-3.resources/noise_dirt_3_v2_speed0.3_aniso0.6.gif "Dirt 3 - Example 4"){zoomable="yes"}
