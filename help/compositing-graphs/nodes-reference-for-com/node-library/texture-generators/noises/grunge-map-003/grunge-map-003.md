...
breadcrumb-title: ""
description: Use the Grunge Map 003 node to create procedural grunge textures for adding surface variation and aging effects.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-003.resources/grungemap-003-ex.gif" class="modal-image" alt="Grunge Map 003 - Example 1" />
        </td>
