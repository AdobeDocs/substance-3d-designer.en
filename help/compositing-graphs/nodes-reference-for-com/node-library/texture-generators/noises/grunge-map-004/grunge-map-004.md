...
breadcrumb-title: ""
description: Use the Grunge Map 004 node to generate procedural grunge patterns for adding weathered and worn texture effects.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-004.resources/grungemap-004-ex.gif" class="modal-image" alt="Grunge Map 004 - Example 1" />
        </td>
