...
![Directional noise 3 - Icon](directional-noise-3.resources/directional-noise-3-01.png "Directional noise 3 - Icon"){width="200px"}
...
![Directional noise 3 - Example 1](directional-noise-3.resources/directional-noise-3-02.png "Directional noise 3 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 3 - Example 2](directional-noise-3.resources/directional-noise-3-03.gif "Directional noise 3 - Example 2"){zoomable="yes"}
...
![Directional noise 3 - Example 3](directional-noise-3.resources/directional-noise-3-04.gif "Directional noise 3 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 3 - Example 4](directional-noise-3.resources/directional-noise-3-05.gif "Directional noise 3 - Example 4"){zoomable="yes"}
