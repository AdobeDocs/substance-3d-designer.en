...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant6.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 1" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant2.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 2" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant4.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant5.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 4" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 5" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant3.jpg" class="modal-image" alt="3D Voronoi Fractal - Example 6" />
        </td>
    </tr>
</table>
