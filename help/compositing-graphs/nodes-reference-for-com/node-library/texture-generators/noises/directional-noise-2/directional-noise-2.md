...
![Directional noise 2 - Icon](directional-noise-2.resources/directional-noise-2-01.png "Directional noise 2 - Icon"){width="200px"}
...
![Directional noise 2 - Example 1](directional-noise-2.resources/directional-noise-2-02.png "Directional noise 2 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 2 - Example 2](directional-noise-2.resources/directional-noise-2-03.gif "Directional noise 2 - Example 2"){zoomable="yes"}
...
![Directional noise 2 - Example 3](directional-noise-2.resources/directional-noise-2-04.gif "Directional noise 2 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Directional noise 2 - Example 4](directional-noise-2.resources/directional-noise-2-05.gif "Directional noise 2 - Example 4"){zoomable="yes"}
