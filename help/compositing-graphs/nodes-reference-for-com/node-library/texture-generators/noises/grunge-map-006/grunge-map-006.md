...
breadcrumb-title: ""
description: Use the Grunge Map 006 node to generate procedural grunge patterns for creating aged and weathered material surfaces.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-006.resources/grungemap-006-ex.gif" class="modal-image" alt="Grunge Map 006 - Example 1" />
        </td>
