...
breadcrumb-title: ""
description: Use the Grunge Map 014 node to generate procedural grunge textures for adding surface detail and wear effects to materials.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-014.resources/grungemap-014-ex.gif" class="modal-image" alt="Grunge Map 014 - Example 1" />
        </td>
