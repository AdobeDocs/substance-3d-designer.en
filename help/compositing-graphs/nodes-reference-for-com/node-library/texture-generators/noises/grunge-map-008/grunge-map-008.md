...
breadcrumb-title: ""
description: Use the Grunge Map 008 node to generate procedural grunge patterns for adding weathered texture details to materials.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-008.resources/grungemap-008-ex.gif" class="modal-image" alt="Grunge Map 008 - Example 1" />
        </td>
