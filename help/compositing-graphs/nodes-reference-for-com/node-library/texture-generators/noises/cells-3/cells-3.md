...
![Cells 3 - Icon](../../../../../../assets/cells_3.png "Cells 3 - Icon"){width="200px"}
...
| <b>Hardness</b> <i>Float</i> | The definition of the cell walls, where a higher value results in more defined, crisp walls. |
| <b>Invert</b> <i>Boolean</i> | Inverts the grayscale values of the image output. |
...
| <b>Pattern size</b> <i>Float2</i> | A multiplier for the size of a scattered disc in its cell., where 1.0 is the full span of the cell. |
| <b>Pattern scale</b> <i>Float</i> | A multiplier for the <b>Pattern size</b>, where 1.0 is the full size. |
| <b>Angle</b> <i>Float</i> | The angle used to set the direction of the discs, in number of turns and starting from horizontal right. |
...
![Cells 3 - Example 1](../../../../../../assets/cells_3_1.png "Cells 3 - Example 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Cells 3 - Example 2](../../../../../../assets/noise_cells_3_v2_speed0.6_aniso0.gif "Cells 3 - Example 2"){zoomable="yes"}
...
![Cells 3 - Example 3](../../../../../../assets/noise_cells_3_v2_speed0.6_aniso1.gif "Cells 3 - Example 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![Cells 3 - Example 4](../../../../../../assets/noise_cells_3_v2_speed0.3_aniso0.6.gif "Cells 3 - Example 4"){zoomable="yes"}
