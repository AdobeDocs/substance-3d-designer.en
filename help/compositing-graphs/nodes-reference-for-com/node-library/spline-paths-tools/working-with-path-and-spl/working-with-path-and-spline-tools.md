...
![Paths Polygon output](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-01.jpg "Paths Polygon output")
...
![Spline Cubic in 2D View](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-02.gif "Spline Cubic in 2D View")
...
![Path tools in Library](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-03.jpg "Path tools in Library")
...
![Paths generation nodes](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-04.jpg "Paths generation nodes"){width="600px"}
...
![Preview Paths node](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-05.jpg "Preview Paths node")
...
![Path to Spline](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-06.jpg "Path to Spline")
...
![Spline tools in Library](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-07.jpg "Spline tools in Library")
...
![Appending splines with link creation modes](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-08.gif "Appending splines with link creation modes")
...
![Preview output on spline node](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-09.jpg "Preview output on spline node")
...
![Spline rendered as segments](working-with-path-and-spline-tools.resources/working-with-path-and-spline-tools-10.jpg "Spline rendered as segments")
