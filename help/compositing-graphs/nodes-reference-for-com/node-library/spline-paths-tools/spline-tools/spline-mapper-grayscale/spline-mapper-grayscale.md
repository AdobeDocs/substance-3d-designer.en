...
<b>Color Map</b> *Grayscale*The input grayscale image that should be mapped along the input splines.
...
<b>Color</b> *Grayscale*The result of mapping the input Color image across the input splines, as a grayscale image.
...
<table>
  <tr>
    ...
    <td>
      <img src="SplineMapperGrayscale-Variant1-After.jpg" alt="SplineMapperGrayscale-Variant1-After">
      <br><i>After</i>
    </td>
  </tr>
</table>
