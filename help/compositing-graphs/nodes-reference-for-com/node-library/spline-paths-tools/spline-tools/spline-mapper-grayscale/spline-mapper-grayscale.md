...
![Node icon](spline-mapper-grayscale.resources/spline-mapper-grayscale-01.png "Node icon")
...
>[!NOTE]
>
> See also [Spline Mapper Color](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-color/spline-mapper-color.md).
...
| <b>Color Map</b> <i>Grayscale</i> | The input grayscale image that should be mapped along the input splines. |
...
|  |  |
|:---|:---|
| <b>Color</b> <i>Grayscale</i> | The result of mapping the input Color image across the input splines, as a grayscale image. |
...
![Node example 2](spline-mapper-grayscale.resources/spline-mapper-grayscale-04.gif "Node example 2")
...
![Node example 3](spline-mapper-grayscale.resources/spline-mapper-grayscale-05.jpg "Node example 3")
