...
![Node icon](spline-mapper-color.resources/spline-mapper-color-01.png "Node icon")
...
![Node example 2](spline-mapper-color.resources/spline-mapper-color-04.gif "Node example 2")
...
![Node example 3](spline-mapper-color.resources/spline-mapper-color-05.jpg "Node example 3")
