...
![Node icon](spline-flow-mapper.resources/spline-flow-mapper-01.png "Node icon")
...
![Node example 2](spline-flow-mapper.resources/spline-flow-mapper-04.gif "Node example 2")
