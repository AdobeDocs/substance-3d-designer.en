...
breadcrumb-title: ""
description: Learn about the paths format specifications and data structure used by path and spline nodes.
...
![Paths Polygon encoded data](paths-format-specifications.resources/paths-format-specifications-01.jpg "Paths Polygon encoded data")
...
![Minimal use case of sample_next](paths-format-specifications.resources/paths-format-specifications-02.png "Minimal use case of sample_next")



![Use case of sample_next in Preview Paths (path_trace)](paths-format-specifications.resources/paths-format-specifications-03.png "Use case of sample_next in Preview Paths (path_trace)")
