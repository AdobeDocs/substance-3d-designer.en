...
>[!NOTE]
>
> See also [MLV color](../../../../../../help/compositing-graphs/nodes-reference-for-com/node-library/filters/blurs/mlv-color/mlv-color.md).

## Input connectors

<b>Input </b>*Grayscale*The grayscale image which should be processed.

## Output connectors

<b>Output</b>*Grayscale*The filtered grayscale image.
