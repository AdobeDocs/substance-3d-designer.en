...
![Histogram equalize: icon](histogram-equalize.resources/histogram-equalize-01.png "Histogram equalize: icon"){width="200px"}
...
![Histogram equalize: Example 1](histogram-equalize.resources/histogram-equalize-04.png "Histogram equalize: Example 1"){zoomable="yes"}
...
![Histogram equalize: Example 2](histogram-equalize.resources/histogram-equalize-07.png "Histogram equalize: Example 2"){zoomable="yes"}
...
![Histogram equalize: Example 3](histogram-equalize.resources/histogram-equalize-10.png "Histogram equalize: Example 3"){zoomable="yes"}
