...
![Histogram compute: icon](histogram-compute.resources/histogram-compute-01.png "Histogram compute: icon"){width="200px"}
...
![Histogram compute: Example 1](histogram-compute.resources/histogram-compute-02.jpg "Histogram compute: Example 1"){zoomable="yes"}
