...
![Quantize Color icon](modify-color-palette.resources/modify-color-palette-01.png "Quantize Color icon"){width="200px"}
...
![Modify color palette: Example 1](modify-color-palette.resources/modify-color-palette-02.png "Modify color palette: Example 1"){zoomable="yes"}

![Modify color palette: Example 2](modify-color-palette.resources/modify-color-palette-03.png "Modify color palette: Example 2"){zoomable="yes"}
