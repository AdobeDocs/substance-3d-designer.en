...
![Color to mask - Icon](color-to-mask.resources/color-to-mask-01.png "Color to mask - Icon"){width="200px"}
...
|  |  |
|:---|:---|
| <b>Input</b> <i>Color</i> | The input color image that a mask should be extracted from based on its colors. |
| <b>Color Input</b> <i>Color</i>   *Available when 'Use color input' is set to 'True'* | The input color image used to define the reference color per pixel. |
...
|  |  |
|:---|:---|
| <b>Output</b> <i>Grayscale</i> | The generated mask as a grayscale bitmap. |
