...
|  |  |
|:---|:---|
| <b>Input</b> <i>Grayscale Input</i> | Source result to modify. |
| <b>Position Map</b> <i>Grayscale Input</i> | Input slot to drive Position parameter. Activated when "Use Position Input" is set to True. Effective value range is small and depends on Contrast map and setting. |
| <b>Contrast Map</b> <i>Grayscale Input</i> | Input slot to drive contrast parameter. Activated when "Use Contrast Input" is set to True. Effective value range is small. |
...
|  |  |
|:---|:---|
| <b>Use Position Input</b> <i>False/True</i> | Toggle use of Position Map input slot. |
| <b>position</b> <i>0.0 - 1.0</i> | Controls or modifies map results to drive the position setting. |
| <b>Use Contrast Input</b> <i>False/True</i> | Toggle use of Contrast Map input slot. |
| <b>contrast</b> <i>0.0 - 1.0</i> | Controls or modifies map results to drive the contrast setting. |
