...
See also: [Anisotropic Kuwahara color](../anisotropic-kuwahara/anisotropic-kuwahara.md)
...
|                                                       |                                                                                                                                                                                                                                                                                                                         |
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>Input</b> <i>Grayscale</i><br><code>PRIMARY</code> | The grayscale image which should be processed.                                                                                                                                                                                                                                                                          |
