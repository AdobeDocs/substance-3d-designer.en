...
![Exporting simplified](exporting-bitmaps.resources/exporting-bitmaps-01.png "Exporting simplified")
...
In the [Graph View](../../interface/the-graph-view/the-graph-view.md), by clicking the Tools button ![](exporting-bitmaps.resources/exporting-bitmaps-03.png) and choosing **"Export Outputs..."**
...
![Export outputs dialog](exporting-bitmaps.resources/exporting-bitmaps-05.png "Export outputs dialog")
...
![Batch export outputs dialog](exporting-bitmaps.resources/exporting-bitmaps-06.png "Batch export outputs dialog")
